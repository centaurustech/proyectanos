...
//presencial
$sSQLpr ="SELECT * FROM `ext_survey_".$idDia."` where `lastpage`='4' ".$sFiltro." order by id asc ";
//echo $sSQL1;
$osurvpr=mysql_query($sSQLpr);
$iCantiodadRespuestasPres = mysql_num_rows($osurvpr);
$ResultadoPreguntaPres = array('24'=>0, '25'=>0,'26'=>0,'27'=>0,'28'=>0,'29'=>0,'30'=>0,'31'=>0,'32'=>0,'33'=>0,'34'=>0,'35'=>0,'36'=>0,'37'=>0,'38'=>0,'39'=>0,'40'=>0,'41'=>0,'42'=>0,'43'=>0,'44'=>0);
$ResultadoPres =array('24'=>0, '25'=>0,'26'=>0,'27'=>0,'28'=>0,'29'=>0,'30'=>0,'31'=>0,'32'=>0,'33'=>0,'34'=>0,'35'=>0,'36'=>0,'37'=>0,'38'=>0,'39'=>0,'40'=>0,'41'=>0,'42'=>0,'43'=>0,'44'=>0);
	while($rssurvPr=mysql_fetch_array($osurvpr)){
	//Busco posicion pregunta segun ubicacion en array 19 son las pregunta
		for ($iCuentaPregP = 25;$iCuentaPregP <= 44; $iCuentaPregP++) {
			$ResultadoPreguntaPres[$iCuentaPregP] += intval(convertirValoresEncuesta($rssurvPr[$iCuentaPregP]));
//			echo $rssurvPr[0].",<br>";
			}
	}
	mysql_free_result($osurvpr);
	
$ResultadoPres[1] =intval($ResultadoPreguntaPres["24"])/$iCantiodadRespuestasPres;
$ResultadoPres[2] =intval($ResultadoPreguntaPres["25"])/$iCantiodadRespuestasPres;
$ResultadoPres[3] =intval($ResultadoPreguntaPres["26"])/$iCantiodadRespuestasPres;
$ResultadoPres[4] =intval($ResultadoPreguntaPres["27"])/$iCantiodadRespuestasPres;
$ResultadoPres[5] =intval($ResultadoPreguntaPres["28"])/$iCantiodadRespuestasPres;
$ResultadoPres[6] =intval($ResultadoPreguntaPres["29"])/$iCantiodadRespuestasPres;
$ResultadoPres[7] =intval($ResultadoPreguntaPres["30"])/$iCantiodadRespuestasPres;
$ResultadoPres[8] =intval($ResultadoPreguntaPres["31"])/$iCantiodadRespuestasPres;
$ResultadoPres[9] =intval($ResultadoPreguntaPres["32"])/$iCantiodadRespuestasPres;
$ResultadoPres[10] =intval($ResultadoPreguntaPres["33"])/$iCantiodadRespuestasPres;
$ResultadoPres[11] =intval($ResultadoPreguntaPres["34"])/$iCantiodadRespuestasPres;
$ResultadoPres[12] =intval($ResultadoPreguntaPres["35"])/$iCantiodadRespuestasPres;
$ResultadoPres[13] =intval($ResultadoPreguntaPres["36"])/$iCantiodadRespuestasPres;
$ResultadoPres[14] =intval($ResultadoPreguntaPres["37"])/$iCantiodadRespuestasPres;
$ResultadoPres[15] =intval($ResultadoPreguntaPres["38"])/$iCantiodadRespuestasPres;
$ResultadoPres[16] =intval($ResultadoPreguntaPres["39"])/$iCantiodadRespuestasPres;
$ResultadoPres[17] =intval($ResultadoPreguntaPres["40"])/$iCantiodadRespuestasPres;
$ResultadoPres[18] =intval($ResultadoPreguntaPres["41"])/$iCantiodadRespuestasPres;
$ResultadoPres[19] =intval($ResultadoPreguntaPres["42"])/$iCantiodadRespuestasPres;
$ResultadoPres[20] =intval($ResultadoPreguntaPres["43"])/$iCantiodadRespuestasPres;
$ResultadoPres[21] =intval($ResultadoPreguntaPres["44"])/$iCantiodadRespuestasPres;


///fin presencial

$sSQL1 ="SELECT * FROM `".$sPRefijoBase."survey_".$idDia."` where `lastpage`='4' ".$sFiltro." order by id asc ";
//echo $sSQL1;
...
echo "</td>";
echo "<td>";
echo "<span id=\"ResultadoPregRelevTotalDia\"></span>%";
echo "</td>";
echo "</tr>";
...
echo "</td>";
echo "<td>";
echo $iCantiodadRespuestasPres;
echo "</td>";
echo "<td>";
echo "";
echo "</td>";
echo "<td>";
echo $iCantiodadRespuestas+$iCantiodadRespuestasPres;
echo "</td>";
echo "</tr>";
...
$oquestiongroup=mysql_query($sSQL);
	...
	echo "<span id=\"PorcentajeGrupo".$iCuentaPregunta."\"></span>";
	echo "</td>";	
	echo "<td>";
	echo "</td>";
	echo "<td>";
	...
	echo "</td>";
	echo "<td>";
	echo "<span id=\"ResultadoPregRelevTotal".$iCuentaPregunta."\"></span>";
	echo "</td>";
	echo "</tr>";
		...
		$iResultadoPregPresencial = ($ResultadoPreguntaPres[intval($iCuentaPregunta)+24]/$iCantiodadRespuestasPres);
		...
		echo "</td>";
		echo "<td valign=\"top\">";
		echo "".round($iResultadoPregPresencial)."%";		
		echo "</td>";
		echo "<td>";
		echo "</td>";
		echo "<td valign=\"top\">";
		...
		//echo "<br>";		
		echo "".round(($iResultadoPregRelev+$iResultadoPregPresencial)/2)."%";	
...
echo "document.getElementById(\"ResultadoPregRelevTotalDia\").innerHTML = \"".round($iResultadoPregRelevTotalDia)."\";";
echo "</script>";
